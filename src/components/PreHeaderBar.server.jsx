...
export default function PreHeaderBar() {
	...
	return (
		<div className="px-5 flex flex-row justify-between py-1 z-20"
				 style={{backgroundColor: 'rgb(27,31,35)'}}
		>
			<div className={'basis-1/3'}>
				<div className="py-0.5 text-gray-100">
					Contact: +1 123 123 123
				</div>
			</div>
			...
			<div className="flex basis-1/3 py-0.5 justify-items-end items-end place-content-end">
				<SearchBar/>

				<a href={"login"} className={"block mx-3 px-3 text-gray-100 hover:text-white whitespace-nowrap"}>
...
export function SocialIcons() {
	return <div className="social_icons flex-row hidden">
		<a
