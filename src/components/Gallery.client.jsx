...
export default function Gallery() {
  ...
  return (
    <div
      ...
      tabIndex="-1"
    >
      <SelectedVariantImage className="w-[80vw] md:w-full h-full md:h-auto object-cover object-center flex-shrink-0 md:flex-shrink-none snap-start md:col-span-4 border border-gray-200 rounded-lg" />
